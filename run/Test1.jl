...
_, energybetaMPO = MBL.energyforbetalist(betalist, ancilla, δτ, h, s, cutoff, "SS", gammescale, dmax)
...
p1 = plot()
scatter!(p1, betalist, mean.(energybetaMPO), markershape= :star5, label="TEBD+purification", xlabel="β", ylabel="Average energy of one site", title="N=$N, h=$h, δτ=$δτ, Model Heisenberg")
